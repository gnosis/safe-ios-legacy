...
public class WalletApplicationService: Assertable {
        ...
        do {
            ...
            return safes.compactMap { address in
                ...
                if let foundAddressBookEntry =
                    ...
                    name = foundAddressBookEntry.name
                }
                return WalletData(id: address,
                                  address: address,
                                  name: name,
                                  state: .readyToUse,
                                  canRemove: true,
    ...
    public func createAndSelectMultisigWallet(walletData: WalletData) -> Bool {
        // A lot of duplicatoin with DeploymentDomainService.createNewDraftWallet
    ...
    public func estimateTransferFee(amount: BigInt,
        ...
        if let wallet = selectedWallet, wallet.type == .multisig {
            return 0
        }
    ...
    public func submitTransaction(_ id: String) throws -> TransactionData {
        ...
        updateRelatedMultisigTransaction(for: tx)
        return transactionData(id)!
    }

    func updateRelatedMultisigTransaction(for personalTx: Transaction) {
        // if tx is submitted (pending) and
