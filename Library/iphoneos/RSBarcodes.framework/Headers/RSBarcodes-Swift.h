...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RSBarcodes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, strong) UIImage * _Nullable code;
...
@property (nonatomic, strong) NSTimer * _Nullable ticker;
...
- (AVCaptureDevicePosition)switchCamera SWIFT_WARN_UNUSED_RESULT;
- (BOOL)toggleTorch SWIFT_WARN_UNUSED_RESULT;
- (AVCaptureDevice * _Nullable)captureDevice SWIFT_WARN_UNUSED_RESULT;
- (void)setupCamera;
+ (AVCaptureVideoOrientation)interfaceOrientationToVideoOrientation:(UIInterfaceOrientation)orientation SWIFT_WARN_UNUSED_RESULT;
- (void)reloadVideoOrientation;
